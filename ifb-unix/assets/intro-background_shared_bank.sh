## Banks folders
mkdir -p /shared/bank/bos_taurus
mkdir -p /shared/bank/homo_sapiens
mkdir -p /shared/bank/nr
...
mkdir -p \
  ...
  ./hg38 ./hg38/hisat2 ./hg38/star-2.7.5a ./hg38/fasta ./hg38/bowtie2 ./hg38/bed
touch \
